...
public class SoundManager {
    ...
    Media bgm = new Media(Paths.get("Space Shooter/src/view/resources/sounds/spaceinvaders1.mp3").toUri().toString());
    ...
    public void playMenuOpenMusic() {
        ...
        Media menuMusic = new Media(Paths.get("Space Shooter/src/view/resources/sounds/fastinvader1.mp3").toUri().toString());
    ...
    public void playCoinCollectMusic() {
        ...
        Media coin = new Media(Paths.get("Space Shooter/src/view/resources/sounds/Pokemon-(Button).mp3").toUri().toString());
    ...
    public void playEnemyDeadMusic() {
        ...
        Media enemyDead = new Media(Paths.get("Space Shooter/src/view/resources/sounds/Roblox-death-sound.mp3").toUri().toString());
    ...
    public void playExplosionMusic() {
        ...
        Media explosion = new Media(Paths.get("Space Shooter/src/view/resources/sounds/explosion.mp3").toUri().toString());
