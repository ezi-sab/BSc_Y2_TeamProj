...
public class GameView extends Group {	
	...
	private FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/Files/StarShooter.fxml"));
    ...
    private final Image blockImage = new Image(getClass().getResourceAsStream("/resources/Images/Space-Block-image.png"));
    private final Image coinImage = new Image(getClass().getResourceAsStream("/resources/Images/Coin-image.png"));
    ...
    private final Image enemyImages[] = {
    		new Image(getClass().getResourceAsStream("/resources/Images/EnemyShip-1-image.png")), 
    		new Image(getClass().getResourceAsStream("/resources/Images/EnemyShip-2-image.png")),
    		new Image(getClass().getResourceAsStream("/resources/Images/EnemyShip-1-image.png"))
    		};
	...
	/**
	 * Gets the current state of game scene where it paused.
	 * @return Scene i.e. current state of the game.
	 */
